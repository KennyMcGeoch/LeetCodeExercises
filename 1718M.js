 ...
 * Memory 48.29MB Beats 100.00%
 */
var constructDistancedSequence = function(n) {
    
    if (n===1)return [1]
    else if (n===2) return [2,1,2]
    else if (n===3) return [3,1,2,3,2]
    else if (n===4) return [4,2,3,2,4,3,1]
    else if (n===5) return [5,3,1,4,3,5,2,4,2]
    else if (n===6) return [6,4,2,5,2,4,6,3,5,1,3]
    else if (n===7) return [7,5,3,6,4,3,5,7,4,6,2,1,2]
    else if (n===8) return [8,6,4,2,7,2,4,6,8,5,3,7,1,3,5]
    ...
    else return [20,18,19,15,13,17,10,16,7,5,3,14,12,3,5,7,10,13,15,18,20,19,17,16,12,14,11,9,4,6,8,2,4,2,1,6,9,11,8]
